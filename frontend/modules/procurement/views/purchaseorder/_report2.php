...
<?php
   ...
   // $summary=0;
    ...
    foreach ($prdetails as $pr) {
        ...
        $append = $append . "<td autosize='0' width='40%' style='vertical-align: top;padding:10px;padding-top:0px;font-size:13px;word-wrap: break-word;'>" . $itemdescription . "</td>";
        $append = $append . "<td width='13%' style='vertical-align: top;font-size:12px;text-align:center;'>" . $quantity . "</td>";
        $append = $append . "<td width='13%' style='font-size:12px;vertical-align: top;padding-left:10px;text-align:center;padding-right:10px;'>" . number_format($price,2) . "</td>";
