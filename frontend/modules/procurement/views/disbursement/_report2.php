...
<tbody>
<tr style="height: 5px;">
<td style="width: 80%; height: 5px; text-align: center;border-bottom:none;" colspan="5"><br />_______________________________________<br />Entity Name</td>
...
<tr style="height: 14px;">
<td style="width: 100%; height: 0px; text-align: center;border-top:none;height:75px;" colspan="7"><span style="vertical-align:top;"> <?php if($assig1=='') { echo '____________________________________________________'; }else{echo'<span style="text-decoration:underline;">'.$assig1.', '.$Assig1Position.'</span>';} ?><br>Printed Name, Designation and Signature of Supervisor</span></td>
</tr>
<tr style="height: 14px;">
