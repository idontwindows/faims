...
<div style="margin-bottom: 10px;">    
    <?php 
    echo Html::button('Add Programs  <i class="glyphicon glyphicon-tasks"></i>', ['value' => Url::to(['budgetallocationitemdetails/additemdetails', 'id'=>$budgetAllocationItemId, 'year'=>1, 'program'=>'setup']), 'title' => 'Add Budget Allocation Items', 'class' => 'btn btn-info', 'style'=>'margin-right: 6px; display: "";', 'id'=>'buttonAddBudgetallocationItem']);
    ?>
</div>
<?= GridView::widget([
        'dataProvider' => $dataProvider,
        //'filterModel' => $searchModel,
        'id'=>'program-items-setup', //additional
