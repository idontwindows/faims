        ...
        <?= GridView::widget([
                ...
                'panel' => [
                    ...
                    'before'=>Html::button('View Attachments', ['value' => Url::to(['request/viewattachments', 'id'=>$model->request_id]),     
                                                                ...
                                                                Html::button('Submit', ['value' => Url::to(['request/submit', 'id'=>$model->request_id]), 'title' => 'Submit', 'class' => $params['btnClass'], 'style'=>'margin-right: 6px;'.((($model->status_id < Request::STATUS_SUBMITTED)) ? ($model->attachments ? '' : 'display: none;') : 'display: none;'), 'id'=>'buttonSubmit']),
